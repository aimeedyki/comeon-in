...
import { Button, CheckInput } from '../common';
...
const TermsAndConditions = () => {
  return (
    <div className="terms">
      ...
      <p className="terms__heading-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur accumsan.</p>
      ...
      <CheckInput label="I accept the terms and conditions"/>
      <Button>
        Continue
      </Button>
    </div>
